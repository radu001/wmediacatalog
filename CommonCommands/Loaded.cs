...
namespace Common.Commands
{
    public class Loaded
    {
        ...
        public static readonly DependencyProperty CommandProperty =
            DependencyProperty.RegisterAttached("Command", typeof(ICommand), typeof(Loaded),
        ...
        private static void CommandProperty_Changed(DependencyObject dependencyObject, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (element != null)
            {
                LoadedBehavior behavior = GetOrCreateBehavior(element);
        ...
        public static readonly DependencyProperty CommandParameterProperty =
             DependencyProperty.RegisterAttached("CommandParameter", typeof(object),
                typeof(Loaded), new PropertyMetadata(CommandParameterProperty_Changed));
        ...
        private static LoadedBehavior GetOrCreateBehavior(Control element)
        {
            LoadedBehavior behavior = element.GetValue(LoadedBehaviorProperty) as LoadedBehavior;
            if (behavior == null)
            {
                behavior = new LoadedBehavior(element);
                element.SetValue(LoadedBehaviorProperty, behavior);
            }

            return behavior;
        }

        public static LoadedBehavior GetLoadedBehavior(DependencyObject obj)
        {
            return (LoadedBehavior)obj.GetValue(LoadedBehaviorProperty);
        }

        public static void SetLoadedBehavior(DependencyObject obj,
            LoadedBehavior value)
        {
            obj.SetValue(LoadedBehaviorProperty, value);
        }
        ...
        public static readonly DependencyProperty LoadedBehaviorProperty =
            DependencyProperty.RegisterAttached("LoadedBehavior",
                typeof(LoadedBehavior), typeof(Loaded), null);
    }
}
